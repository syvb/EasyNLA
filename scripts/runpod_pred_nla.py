...
STAGES = ("prep", "gate", "rl", "rl_recon", "eval", "trunc", "trunc_expl", "memsft", "bon", "fvecmp")
...
STAGE_HOURS = {"prep": 0.7, "gate": 0.8, "rl": 4.6, "rl_recon": 3.7, "eval": 1.5, "trunc": 0.4, "trunc_expl": 0.5, "memsft": 2.5, "bon": 0.8, "fvecmp": 0.6}
